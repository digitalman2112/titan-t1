...
videos:
  # - youtube_id: ""
  #   title: "Crossover Arm Cable — Setup"
---

The crossover arm cable (A1) inserts into the cable crossover arm holes (A1-L / A1-R) to position the pulleys for the cable cross over and low pulley options, and stows in holes 28-L / 28-R when not in use.
